...
# In our version, break points can occur at any time (i.e., including during gaps in the telemetry data), 
...
# Modified lines of code are commented with ##MA-TG. 
